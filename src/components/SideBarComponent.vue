                ...
                <ul id="sidebar-links" class="d-flex flex-md-column w-100">
                    <li class="py-3">
                        <router-link :to="{ name: 'home' }"
                            ...
                            <div class="img-container blue" :class="{ 'active': $route.path === '/' }">
                            ...
                            <span class="text-link blue">Home</span>
                        </router-link>
                    </li>
                    ...
                    <li class="py-3">
                        <router-link :to="{ name: 'restaurants' }"
                            class="text-link-responsive nav-link d-flex flex-column text-center">
                            <div class="img-container blue" :class="{ 'active': $route.path === '/restaurants' }">
                            ...
                            <span class="text-link blue">Ristoranti</span>
                        </router-link>
                    </li>
                    ...
                    <li class="py-3">
                        <router-link :to="{ name: 'types' }"
                            class="text-link-responsive nav-link d-flex flex-column text-center">
                            <div class="img-container blue" :class="{ 'active': $route.path === '/types' }">
                            ...
                            <span class="text-link blue">Categorie</span>
                        </router-link>
                    </li>
                    ...
                    <li class="py-3">
                        <router-link :to="{ name: 'user' }"
                            class="text-link-responsive nav-link d-flex flex-column text-center">
                            <div class="img-container blue" :class="{ 'active': $route.path === '/user' }">
