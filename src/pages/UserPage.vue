...
<template>
    <section>
        <div class="container my-5">
            ...
            <p class="fs-4 my-5 text-center">Con DeliveBoo admin puoi gestire, modificare e creare i tuoi ristoranti con
                il relativo
                menù. Hai a
            ...
            <div class="buttons d-flex justify-content-center gap-3">
                <a :href="store.urlBackend + '/register'" target="_blank"
                    class="btn btn-primary px-4 fw-bold py-2">Register</a>
                <a :href="store.urlBackend + '/login'" target="_blank"
                    class="btn btn-secondary px-4 fw-bold py-2">Login</a>
            </div>
        </div>
    </section>
            ...
            <div class="row gap-4 py-5">
                ...
                <div class="col">
                    ...
                    <p>Con i grafici interattivi di DeliveBoo, hai una finestra cristallina sul tuo ristorante. Monitora
                        vendite, clienti, tempi di attesa e altro ancora, prendendo decisioni informate per ottimizzare
                        il
                        tuo business.<br>
                        DeliveBoo ti aiuta a:
                    <ul class="fa-ul">
                        <li><span class="fa-li"><font-awesome-icon icon="fa-solid fa-chart-line" /></span>Controllare il
                            tuo
                            ristorante
                        </li>
                        <li><span class="fa-li"><font-awesome-icon icon="fa-solid fa-user" /></span>Prendere decisioni
                            informate</li>
                        <li><span class="fa-li"><font-awesome-icon icon="fa-solid fa-arrows-rotate" /></span>Aggiornare
                            periodicamente
                        </li>
                    </ul>
                    </p>
            ...
            <div class="row gap-3 justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="glass text-center p-3">
                        <div>
                            <font-awesome-icon icon="fa-solid fa-utensils" class="fa-3x mb-3" />
                            <h5>Piatti</h5>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="glass  text-center p-3">
                        <div>
                            <font-awesome-icon icon="fa-solid fa-user" class="fa-3x mb-3" />
                            <h5>Clienti</h5>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="glass text-center p-3">
                        <div>
                            <font-awesome-icon icon="fa-solid fa-clock" class="fa-3x mb-3" />
                            <h5>Ordini</h5>
    ...
    <footer>
        <div class="container mt-5">
            <p class="text-center my-5">Made with &hearts; by</p>
            <div class="row gap-4">
                <div class="col">
